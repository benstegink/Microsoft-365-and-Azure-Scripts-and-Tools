...
.DESCRIPTION
    ...
    To follow the examples, the Connect-SPOSite.ps1 script is also needed.
.EXAMPLE
    C:>. ./Connect-SPOSite.ps1
    $ctx = Connect-SPOSite https://[mysharepointsite].sharepoint.com
    $web = $ctx.Web
...
.EXAMPLE
    C:>. ./Connect-SPOSite.ps1
    $cts = Connect-SPOSite https://[mysharepointsite].sharepoint.com
    $web = $ctx.Web
...
Source: http://www.itunity.com/article/loading-specific-values-lambda-expressions-sharepoint-csom-api-windows-powershell-1249
Created: 2015-04-01
